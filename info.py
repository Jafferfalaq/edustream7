...
BOT_TOKEN = environ.get('BOT_TOKEN', '7870614377:AAEXRMpC8UpjFWmpVceNNXjek6hDecwzg7o')  # Telegram Bot Token
...
AUTH_CHANNEL = list(map(int, environ.get("AUTH_CHANNEL", "-1002148927348").split()))  # Allowed channels for authorization
...
FQDN = getenv("FQDN", "closed-kippy-toon55-7e9ac508.koyeb.app") or BIND_ADDRESS  # Full domain name or fallback to bind address
